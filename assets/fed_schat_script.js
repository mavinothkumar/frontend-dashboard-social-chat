jQuery( document ).ready(
	function ($) {
		var body = $( 'body' );
		body.on(
			'click', '.fed_wa_footer_chat_container', function (e) {
		...
		body.on(
			'click', '#fed_whatsapp_add_new_user_button', function (e) {
				var click = $( this );
		...
		body.on(
			'click', '.fed_whatsapp_delete_user_form', function (e) {
